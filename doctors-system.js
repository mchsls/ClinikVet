...
class DoctorSystem {
    ...
    updateDoctorInfo() {
        ...
        if (doctorSpecialization) {
            doctorSpecialization.textContent = window.authSystem.currentUser.specialization || 'Врач';
        }
    }
    ...
    loadDoctorAppointments() {
        ...
        if (appointmentsCount) {
            appointmentsCount.textContent = doctorAppointments.length;
        }
    ...
    loadMedicalHistory() {
        ...
        if (historyCount) {
            historyCount.textContent = medicalHistory.length;
        }
